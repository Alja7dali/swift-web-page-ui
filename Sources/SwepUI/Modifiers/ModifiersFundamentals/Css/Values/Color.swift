...
public extension Value where Kind: HasValueOfColor {
  ...
  static func darkGreen           (_ a: Double = 1) -> Self { return rgba(0  , 100, 0  , a) }
  static func darkGrey            (_ a: Double = 1) -> Self { return rgba(169, 169, 169, a) }
  ...
  static var darkGreen           : Self { return rgb(0  , 100, 0  ) }
  static var darkGrey            : Self { return rgb(169, 169, 169) }
