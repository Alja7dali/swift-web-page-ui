...
public protocol View {
  ...
  /// The builder for the body of this view.
  ///
  /// When you implement an essential-view, you must implement it.
  /// The builder is used to create the body of your essential-view.
  /// Essential-views are views that are used to represent the content
  /// of pure html elements. For example, the body of a ``<div>``
  /// element is a ``Div`` view. The body of a ``<p>`` element is a
  /// ``P`` view.
  ///
  ///     struct MyView: View {
  ///         var body: some View {
